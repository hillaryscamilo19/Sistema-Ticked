...
function extractCategoryName(category: { name?: string } | string | undefined): string {
    ...
    <div className="page-container">
      ...
      <div className="main-container">
        <div className="content-header">
          <h2 className="content-title">Listado de tickets asignados al usuario.</h2>
        </div>
                ...
                <div className="ticket-content">
                  <div className="ticket-main-info">
                    ...
                    <div className="ticket-metadata">
                      <span>Fecha: {new Date(ticket.created_at || ticket.createdAt).toLocaleDateString("es-ES")}</span>
                  ...
                  <div className="ticket-department">
                    ...
                    <div className="relative-date">{formatRelativeDate(ticket.createdAt || ticket.created_at)}</div>
                  </div>
                  ...
                  <div className="ticket-assignment">
                    ...
                    <div className="ticket-category">
                      ...
                      <span className="category-name">{extractCategoryName(ticket.category)}</span>
                    </div>
                  </div>
